...
import sv.edu.udb.configuration.wed.ApiError;
import sv.edu.udb.configuration.wed.ApiErrorWrapper;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handle500Exception(
            final Exception ex,
            final WebRequest request) {
    ...
    private ApiError buildApiError(final HttpStatus httpStatus, final Exception ex) {
        ...
        if (isMissingRequestParameterException(ex)) {
            ...
            MissingPathVariableException missingPathEx =
